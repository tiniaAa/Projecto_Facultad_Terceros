import { r as m, p as x, M as y, e as t, E as l, R as k, x as r, u as i, a1 as g, S as C, ay as I, D as $, q as c, ap as w, al as d } from "./copilot-CdD0jRv0.js";
var E = Object.defineProperty, S = Object.getOwnPropertyDescriptor, b = (e, n, a, s) => {
  for (var o = s > 1 ? void 0 : s ? S(n, a) : n, p = e.length - 1, u; p >= 0; p--)
...
let v = class extends y {
  ...
  renderUserButton() {
    const e = i.userInfo?.validLicense, n = e ? _ : P, a = e ? "text-amber-12 dark:text-amber-11" : "text-blue-12 dark:text-blue-11", s = this.getUserName() !== "Log in";
    return r`
      <vaadin-button
  ...
  renderDevelopmentWorkflow() {
    const e = C(), n = I(), a = this.getDevelopmentWorkflowConfig(e, n), s = a?.bgClass ?? "", o = a?.colorClass ?? "", p = this.resolveIcon(a), u = a?.rotateIcon ? `rotate-180 ${o}` : o, h = this.resolveTitle(a), f = a?.displayMessage ?? "";
    return r`
      <vaadin-button
  ...
  handleDevelopmentWorkflowClick() {
    $("use-dev-workflow-guide"), c.openPanel(w), this.closePopover();
  }
  handleAppInfoClick() {
