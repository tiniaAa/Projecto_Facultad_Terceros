  ...
  render() {
      ...
      return c`
        ...
        <div class="impersonator-container">
          <div class="empty-state">
            <vaadin-icon class="empty-icon" .svg="${n.accountCircle}"></vaadin-icon>
    ...
    return c`
      ...
      this.username = t.detail.value, this.errorMessage = "";
            ...
            <vaadin-icon slot="prefix" .svg="${n.accountCircle}"></vaadin-icon>
          </vaadin-text-field>
      ...
      (t) => c`
                      <div class="recent-user-item">
                        ...
                        <vaadin-button
                          ...
                          <vaadin-icon .svg="${n.delete}"></vaadin-icon>
