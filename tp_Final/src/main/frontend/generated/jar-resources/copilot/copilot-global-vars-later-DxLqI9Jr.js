import { c as d, g as w, a as P, t as D, s as c, P as u, i as N, b as y, d as k, e as h, x as m, f as F, h as R, B as E, m as A, o as b, E as L, j as v, C as g, k as V, l as U } from "./copilot-CdD0jRv0.js";
function l(o, t) {
  ...
  })) : N(o) ? (D("show-in-ide", { attach: t ?? !1 }), c(`${u}show-in-ide`, { ...y(o), attach: t ?? !1 })) : (k("show-in-ide"), c(`${u}show-in-ide`, o));
}
d.on("show-in-ide", (o) => {
...
function T() {
  p(
    m`<div class="flex flex-col gap-4 h-screen items-center justify-center">
      <vaadin-icon .svg=${h.rotatingSpinner}></vaadin-icon>
...
function x(o) {
  p(
    ...
    if (t.data.success)
      sessionStorage.setItem(f, "true"), T(), S();
    else {
...
function $() {
  sessionStorage.getItem(f) ? (T(), S()) : j();
}
class W {
  constructor(t) {
    this._currentTree = t;
